...
Assumeutxo is a feature that allows fast bootstrapping of a validating goldbrixd
instance.
...
```
$ goldbrix-cli -rpcclienttimeout=0 loadtxoutset /path/to/input
```
...
```
$ goldbrix-cli -rpcclienttimeout=0 dumptxoutset /path/to/output rollback
```
