# PSBT Howto for GoldBrix

Since GoldBrix 0.17, an RPC interface exists for Partially Signed GoldBrix
...
PSBT is an interchange format for GoldBrix transactions that are not fully signed
...
Overall, the construction of a fully signed GoldBrix transaction goes through the
following steps:
...
- An **Extractor** produces a valid GoldBrix transaction (in network format)
...
#### Multisig with multiple GoldBrix instances
