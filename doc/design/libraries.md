...
| Name                     | Description |
|--------------------------|-------------|
| *libbitcoin_cli*         | RPC client functionality used by *goldbrix-cli* executable |
...
| *libbitcoinqt*           | GUI functionality used by *goldbrix-qt* and *goldbrix-gui* executables. |
| *libbitcoin_ipc*         | IPC functionality used by *goldbrix-node* and *goldbrix-gui* executables to communicate when [`-DENABLE_IPC=ON`](multiprocess.md) is used. |
| *libbitcoin_node*        | P2P and RPC server functionality used by *goldbrixd* and *goldbrix-qt* executables. |
| *libbitcoin_util*        | Home for common functionality shared by different executables and libraries. Similar to *libbitcoin_common*, but lower-level (see [Dependencies](#dependencies)). |
| *libbitcoin_wallet*      | Wallet functionality used by *goldbrixd* and *goldbrix-wallet* executables. |
| *libbitcoin_wallet_tool* | Lower-level wallet functionality used by *goldbrix-wallet* executable. |
| *libbitcoin_zmq*         | [ZeroMQ](../zmq.md) functionality used by *goldbrixd* and *goldbrix-qt* executables. |
...
goldbrix-cli[goldbrix-cli]-->libbitcoin_cli;

goldbrixd[goldbrixd]-->libbitcoin_node;
goldbrixd[goldbrixd]-->libbitcoin_wallet;

goldbrix-qt[goldbrix-qt]-->libbitcoin_node;
goldbrix-qt[goldbrix-qt]-->libbitcoinqt;
goldbrix-qt[goldbrix-qt]-->libbitcoin_wallet;

goldbrix-wallet[goldbrix-wallet]-->libbitcoin_wallet;
goldbrix-wallet[goldbrix-wallet]-->libbitcoin_wallet_tool;
...
class goldbrix-qt,goldbrixd,goldbrix-cli,goldbrix-wallet bold
```
</td></tr><tr><td>
...
- *libbitcoin_common* is a home for miscellaneous shared code used by different GoldBrix applications. It should not depend on anything other than *libbitcoin_util*, *libbitcoin_consensus*, and *libbitcoin_crypto*.
...
- Validation code is moving from *libbitcoin_node* to *libbitcoin_kernel* as part of [The libbitcoinkernel Project #27587](https://github.com/GOLDBRIX-GBX/goldbrix-core/issues/27587)
