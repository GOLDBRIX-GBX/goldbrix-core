...
complete --command goldbrix-qt --no-files

# Extract options
function __fish_goldbrixqt_get_options
...
complete \
    --command goldbrix-qt \
    --arguments "(__fish_goldbrixqt_get_options --nofiles)"
