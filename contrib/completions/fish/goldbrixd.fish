...
complete --command goldbrixd --no-files

# Extract options
function __fish_goldbrixd_get_options
...
complete \
    --command goldbrixd \
    --arguments "(__fish_goldbrixd_get_options --nofiles)"
