...
# Extract options
function __fish_goldbrix_tx_get_options
...
# Extract commands
function __fish_goldbrix_tx_get_commands
...
complete \
    --command goldbrix-tx \
    --condition "not __fish_goldbrix_seen_cmd (__fish_goldbrix_tx_get_commands --commandsonly)" \
    --arguments "(__fish_goldbrix_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command goldbrix-tx \
    --arguments "(__fish_goldbrix_tx_get_commands)" \
    --no-files
